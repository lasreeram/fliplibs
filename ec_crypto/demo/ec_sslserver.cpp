...
void service(SSLServerSocket* sock){
...
void print_help(){
	debug_lib::log(  "ec_sslserver <hostname> <port>" );
}
...
int main(int argc, char** argv){
	...
	try{
		...
		do{
			...
			SSLServerSocket* sslsock = new SSLServerSocket( (TCPAcceptSocket*) acceptsock, "/home/hduser/ssl/ecurve/server" ); 
			service(sslsock);
			sslsock->shutdown();
			delete sslsock;
